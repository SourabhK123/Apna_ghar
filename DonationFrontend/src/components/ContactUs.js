          ...
          <Col md={8}>
            <div className="bg-lighter mt-0 p-0 rounded">
              ...
              <p className="text-center font-weight-bold mb-4 lead">
                In India, we often see orphanage and donors working in silos lacking
                a common standardized platform to handle end-to-end donation
                processes.
                <span className="text-primary">ApnaGhar</span> aims to
              ...
              <p className="text-center lead">
                ...
                with
                <span className="text-primary">ApanaGhar</span>, please
