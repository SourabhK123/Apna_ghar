    ...
    <>
      ...
      <Container className="bg-light text-center mt-2 p-2 rounded">
        <h1 className="display-4 text-primary mb-2 font-weight-bold">
          ApnaGhar: Orphanage Donation System
        </h1>
        <p className="lead">
      ...
      <Container className="mt-5 bg-white rounded shadow-lg">
        ...
        <Row className="align-items-center mb-5">
          ...
          <Col md={6}>
            <h2 className="mb-4">ApnaGhar</h2>
            <p>
              In India, we often see Orphanages and donors working in silos lacking a
              common standardized platform to handle end-to-end donation
              processes. ApnaGhar aims to address this critical issue by
          ...
          <Col md={3}>
            <Card className="p-3 mb-3 bg-success text-white rounded shadow">
              <Card.Body>
                ...
                <Card.Text>
                  The ApanaGHar is a volunteer-based, zero-funds
